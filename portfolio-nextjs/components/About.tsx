        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <div className="px-4 py-2 rounded-lg bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800">
                <span className="text-sm font-semibold text-primary-700 dark:text-primary-400">📍 {t.about.location}</span>
              </div>
              ...
              <div className="px-4 py-2 rounded-lg bg-accent-50 dark:bg-accent-900/20 border border-accent-200 dark:border-accent-800">
                <span className="text-sm font-semibold text-accent-700 dark:text-accent-400">⭐ {t.about.upworkVerified}</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            {services.map((service, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-primary-500 to-accent-500 flex items-center justify-center mb-4 group-hover:scale-110 smooth-transition">
